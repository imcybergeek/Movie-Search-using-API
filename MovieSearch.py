...
if __name__ == "__main__":
    ...
    main = Frame(root, bg='#202325', padx=10, pady=10)
    main.place(relx=.5, rely=.225, anchor="center")

    # Frame for Output related widgets
    output = Frame(root, bg='#202325', padx=10, pady=10)
    output.place(relx=.5, rely=.6, anchor="center")

    # Label for Search Term
    Label(main, text='Enter Movie Name', bg='black',
          fg='white', font='Verdana', padx=10).grid(row=0)

    # Text Widget to Output Movie Info
    MoviesData = Text(output, width=75, height=15, bg='black',
                      fg='white', padx=10, state="disabled", font='Ariel')
    ...
    searchTerm = Entry(main, font='Verdana')
    ...
    searchBtn = Button(main, text='Search', bg='black', fg='white',
